...
protected:
  ...
  template <typename T>
  inline void initData(const RuntimeData::RuntimeDataId key, const DataValue::Type type, const T value, const uint32_t block, const uint32_t field);
...
//----------------------------------------------------------------------------
template <typename T>
inline void RuntimeDataMethods::initData(const RuntimeData::RuntimeDataId key, const DataValue::Type type, const T value, const uint32_t block, const uint32_t field)
{
